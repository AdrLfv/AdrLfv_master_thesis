...
% TODO réécrire complètement cette section
...
About the sound, the Adafruit Circuit Playground embarks a built in buzzer. The Mini Speaker that is implemented here is the SQMS5002S4036A. This device is a miniature magnetic speaker not adapted for playing detailed audio. It is more used for beeping and buzzing and for simple bleepy tunes. 

% TODO dire qu'il est possible de changer de tonalité
% TODO Justifier les choix techniques
...
% TODO Ajouter capacitée de changer la tonalité automatiquement en fonction de la partition. Possibilité de rajouter le jeu d'une alteration avec trois boutons bémol, dièse et bécart jouable avec l'index de la main gauche

% TODO Refaire l'electronique avec un meilleur speaker

% TODO relire ce qui suit
